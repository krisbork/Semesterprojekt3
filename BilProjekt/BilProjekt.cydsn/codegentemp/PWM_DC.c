...
void PWM_DC_Stop(void) 
{
    ...
    *******************************************************************************/
    ...
    {
        CY_SET_REG8(PWM_DC_COUNTER_LSB_PTR, counter);
    }
    ...
    *******************************************************************************/
    uint8 PWM_DC_ReadCounter(void) 
    {
        ...
        return (CY_GET_REG8(PWM_DC_CAPTURE_LSB_PTR));
    }
...
void PWM_DC_WritePeriod(uint8 period) 
{
    ...
    #else
        CY_SET_REG8(PWM_DC_PERIOD_LSB_PTR, period);
    #endif /* (PWM_DC_UsingFixedFunction) */
}
    ...
    *******************************************************************************/
                                       ...
                                       
    {
        ...
        #else
            CY_SET_REG8(PWM_DC_COMPARE1_LSB_PTR, compare);
        #endif /* (PWM_DC_UsingFixedFunction) */
            ...
            #else
                CY_SET_REG8(PWM_DC_COMPARE2_LSB_PTR, (compare + 1u));
            #endif /* (PWM_DC_UsingFixedFunction) */
    ...
    *******************************************************************************/
                                        ...
                                        
    {
        ...
        #else
            CY_SET_REG8(PWM_DC_COMPARE2_LSB_PTR, compare);
        #endif /* (PWM_DC_UsingFixedFunction) */
    }
#endif /* UseOneCompareMode */
    ...
    *******************************************************************************/
    ...
    {
        #if(PWM_DC_UsingFixedFunction)
            return ((uint8)CY_GET_REG16(PWM_DC_COMPARE1_LSB_PTR));
        #else
            return (CY_GET_REG8(PWM_DC_COMPARE1_LSB_PTR));
        #endif /* (PWM_DC_UsingFixedFunction) */
    }
    ...
    *******************************************************************************/
    ...
    {
        return (CY_GET_REG8(PWM_DC_COMPARE2_LSB_PTR));
    }
...
{
    #if(PWM_DC_UsingFixedFunction)
        return ((uint8)CY_GET_REG16(PWM_DC_PERIOD_LSB_PTR));
    #else
        return (CY_GET_REG8(PWM_DC_PERIOD_LSB_PTR));
    #endif /* (PWM_DC_UsingFixedFunction) */
}
