...
module top ;
    ...
    PWM_v3_30_1 PWM_DC (
        ...
        .ph1(Net_103),
        .ph2(Net_104));
    defparam PWM_DC.Resolution = 8;

	wire [0:0] tmpOE__Pin_1_7_net;
	wire [0:0] tmpFB_0__Pin_1_7_net;
	wire [0:0] tmpIO_0__Pin_1_7_net;
	wire [0:0] tmpINTERRUPT_0__Pin_1_7_net;
	electrical [0:0] tmpSIOVREF__Pin_1_7_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_1_7
		 (.oe(tmpOE__Pin_1_7_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_1_7_net[0:0]}),
		  .io({tmpIO_0__Pin_1_7_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_1_7_net),
		  .interrupt({tmpINTERRUPT_0__Pin_1_7_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_1_7_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("954a4955-e221-4486-88d5-d106733b2cdb"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Pin_PWM_DC_net;
	wire [0:0] tmpFB_0__Pin_PWM_DC_net;
	wire [0:0] tmpIO_0__Pin_PWM_DC_net;
	wire [0:0] tmpINTERRUPT_0__Pin_PWM_DC_net;
	electrical [0:0] tmpSIOVREF__Pin_PWM_DC_net;

	cy_psoc3_pins_v1_10
		#(.id("1a73d7cb-f549-445e-ac07-226d94608898"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_PWM_DC
		 (.oe(tmpOE__Pin_PWM_DC_net),
		  .y({Net_90}),
		  .fb({tmpFB_0__Pin_PWM_DC_net[0:0]}),
		  .io({tmpIO_0__Pin_PWM_DC_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_PWM_DC_net),
		  .interrupt({tmpINTERRUPT_0__Pin_PWM_DC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_PWM_DC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Pin_RPi_net;
	wire [0:0] tmpFB_0__Pin_RPi_net;
	wire [0:0] tmpIO_0__Pin_RPi_net;
	wire [0:0] tmpINTERRUPT_0__Pin_RPi_net;
	electrical [0:0] tmpSIOVREF__Pin_RPi_net;

	cy_psoc3_pins_v1_10
		#(.id("db9f4953-0d96-4210-8237-78ba3dd224f7"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_RPi
		 (.oe(tmpOE__Pin_RPi_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_RPi_net[0:0]}),
		  .io({tmpIO_0__Pin_RPi_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_RPi_net),
		  .interrupt({tmpINTERRUPT_0__Pin_RPi_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_RPi_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_SensorRight_Trig_net;
	wire [0:0] tmpFB_0__Pin_SensorRight_Trig_net;
	wire [0:0] tmpIO_0__Pin_SensorRight_Trig_net;
	wire [0:0] tmpINTERRUPT_0__Pin_SensorRight_Trig_net;
	electrical [0:0] tmpSIOVREF__Pin_SensorRight_Trig_net;

	cy_psoc3_pins_v1_10
		#(.id("152492c3-d266-492d-bf91-b7c7f9ea207d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .ovt_slew_control(2'b00),
		  .input_buffer_sel(2'b00))
		Pin_SensorRight_Trig
		 (.oe(tmpOE__Pin_SensorRight_Trig_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_SensorRight_Trig_net[0:0]}),
		  .io({tmpIO_0__Pin_SensorRight_Trig_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_SensorRight_Trig_net),
		  .interrupt({tmpINTERRUPT_0__Pin_SensorRight_Trig_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_SensorRight_Trig_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_SensorRight_Echo_net;
	wire [0:0] tmpFB_0__Pin_SensorRight_Echo_net;
	wire [0:0] tmpIO_0__Pin_SensorRight_Echo_net;
	wire [0:0] tmpINTERRUPT_0__Pin_SensorRight_Echo_net;
	electrical [0:0] tmpSIOVREF__Pin_SensorRight_Echo_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .ovt_slew_control(2'b00),
		  .input_buffer_sel(2'b00))
		Pin_SensorRight_Echo
		 (.oe(tmpOE__Pin_SensorRight_Echo_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_SensorRight_Echo_net[0:0]}),
		  .io({tmpIO_0__Pin_SensorRight_Echo_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_SensorRight_Echo_net),
		  .interrupt({tmpINTERRUPT_0__Pin_SensorRight_Echo_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_SensorRight_Echo_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    PWM_v3_30_2 PWM_Servo (
        .reset(1'b0),
        .clock(Net_123),
        .tc(Net_124),
        .pwm1(Net_125),
	...
	cy_clock_v1_0
		#(.id("d82c2380-0d33-4e07-a6e1-17a2c1c9662c"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__Pin_PWM_Servo_net;
	wire [0:0] tmpFB_0__Pin_PWM_Servo_net;
	wire [0:0] tmpIO_0__Pin_PWM_Servo_net;
	wire [0:0] tmpINTERRUPT_0__Pin_PWM_Servo_net;
	electrical [0:0] tmpSIOVREF__Pin_PWM_Servo_net;

	cy_psoc3_pins_v1_10
		#(.id("0a1135c6-d369-4a13-be4a-3a293efae344"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_PWM_Servo
		 (.oe(tmpOE__Pin_PWM_Servo_net),
		  .y({Net_140}),
		  .fb({tmpFB_0__Pin_PWM_Servo_net[0:0]}),
		  .io({tmpIO_0__Pin_PWM_Servo_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_PWM_Servo_net),
		  .interrupt({tmpINTERRUPT_0__Pin_PWM_Servo_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_PWM_Servo_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_SensorFront_Trig_net;
	wire [0:0] tmpFB_0__Pin_SensorFront_Trig_net;
	wire [0:0] tmpIO_0__Pin_SensorFront_Trig_net;
	wire [0:0] tmpINTERRUPT_0__Pin_SensorFront_Trig_net;
	electrical [0:0] tmpSIOVREF__Pin_SensorFront_Trig_net;

	cy_psoc3_pins_v1_10
		#(.id("b1ff5a9c-653a-4592-9dd2-d2690ff2e0a7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .ovt_slew_control(2'b00),
		  .input_buffer_sel(2'b00))
		Pin_SensorFront_Trig
		 (.oe(tmpOE__Pin_SensorFront_Trig_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_SensorFront_Trig_net[0:0]}),
		  .io({tmpIO_0__Pin_SensorFront_Trig_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_SensorFront_Trig_net),
		  .interrupt({tmpINTERRUPT_0__Pin_SensorFront_Trig_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_SensorFront_Trig_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_SensorFront_Echo_net;
	wire [0:0] tmpFB_0__Pin_SensorFront_Echo_net;
	wire [0:0] tmpIO_0__Pin_SensorFront_Echo_net;
	wire [0:0] tmpINTERRUPT_0__Pin_SensorFront_Echo_net;
	electrical [0:0] tmpSIOVREF__Pin_SensorFront_Echo_net;

	cy_psoc3_pins_v1_10
		#(.id("8f3da12a-1264-41b2-a0b5-5e0207a2d1d6"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .ovt_slew_control(2'b00),
		  .input_buffer_sel(2'b00))
		Pin_SensorFront_Echo
		 (.oe(tmpOE__Pin_SensorFront_Echo_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_SensorFront_Echo_net[0:0]}),
		  .io({tmpIO_0__Pin_SensorFront_Echo_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_SensorFront_Echo_net),
		  .interrupt({tmpINTERRUPT_0__Pin_SensorFront_Echo_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_SensorFront_Echo_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_interrupt_net;
	wire [0:0] tmpIO_0__Pin_interrupt_net;
	electrical [0:0] tmpSIOVREF__Pin_interrupt_net;

	cy_psoc3_pins_v1_10
		#(.id("415e8288-6bec-4985-a285-9189aa89cee8"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_interrupt
		 (.oe(tmpOE__Pin_interrupt_net),
		  .y({1'b0}),
		  .fb({Net_154}),
		  .io({tmpIO_0__Pin_interrupt_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_interrupt_net),
		  .interrupt({Net_156}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_interrupt_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
